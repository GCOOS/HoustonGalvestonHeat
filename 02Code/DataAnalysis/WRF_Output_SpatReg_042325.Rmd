...
HourlyMeans17_cavg <- read.csv("../../03ProcessedData/HourlyMeans_2017_042225.csv")
...
HourlyMeans17_cavg$LandUse <- LU_dict$New_Name[HourlyMeans17_cavg$LandUse]
...
HourlyMeans17_cavg$LandUse <- as.factor(HourlyMeans17_cavg$LandUse)
HourlyMeans17_cavg$LandUse <- relevel(HourlyMeans17_cavg$LandUse, ref="Crop")
...
n17c <- length(unique(HourlyMeans17_cavg$GridCell)) #observations per hour
...
#Re-organize 2017 - Temperature
#columns are one for each hour, one for distance2ocean, and one for land use
ReOrg_Temp17_cavg <- as.data.frame(matrix(0, ncol=(length(HoursOfInterest) + 2), nrow =n17c))

HourlyMeans17_cavg <- HourlyMeans17_cavg[order(HourlyMeans17_cavg$GridCell),] #make sure the order is consistent so you know which points are which

#Get your hourly temps - response
ReOrg_Temp17_cavg[,1] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 12]
ReOrg_Temp17_cavg[,2] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 13]
ReOrg_Temp17_cavg[,3] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 14]
ReOrg_Temp17_cavg[,4] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 15]
ReOrg_Temp17_cavg[,5] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 16]
ReOrg_Temp17_cavg[,6] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 17]
ReOrg_Temp17_cavg[,7] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 18]
ReOrg_Temp17_cavg[,8] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 19]
ReOrg_Temp17_cavg[,9] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 20]
ReOrg_Temp17_cavg[,10] <- HourlyMeans17_cavg$X2mTemp[HourlyMeans17_cavg$hour == 21]

#Get your fixed effects
ReOrg_Temp17_cavg[,11] <- HourlyMeans17_cavg$Dist2Ocean[HourlyMeans17_cavg$hour == 12]
ReOrg_Temp17_cavg[,12] <- HourlyMeans17_cavg$LandUse[HourlyMeans17_cavg$hour == 12]
names(ReOrg_Temp17_cavg) <- c("y.1", "y.2", "y.3", "y.4", "y.5", "y.6", "y.7", "y.8", "y.9", "y.10", "Dist2Ocean", "LandUse")


#re-organize 2017 humidity
ReOrg_RH17_cavg <- as.data.frame(matrix(0, ncol=(length(HoursOfInterest) + 2), nrow =n17c))

#Get your hourly temps - response
ReOrg_RH17_cavg[,1] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 12]
ReOrg_RH17_cavg[,2] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 13]
ReOrg_RH17_cavg[,3] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 14]
ReOrg_RH17_cavg[,4] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 15]
ReOrg_RH17_cavg[,5] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 16]
ReOrg_RH17_cavg[,6] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 17]
ReOrg_RH17_cavg[,7] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 18]
ReOrg_RH17_cavg[,8] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 19]
ReOrg_RH17_cavg[,9] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 20]
ReOrg_RH17_cavg[,10] <- HourlyMeans17_cavg$RelHumid[HourlyMeans17_cavg$hour == 21]

#Get your fixed effects
ReOrg_RH17_cavg[,11] <- HourlyMeans17_cavg$Dist2Ocean[HourlyMeans17_cavg$hour == 12]
ReOrg_RH17_cavg[,12] <- HourlyMeans17_cavg$LandUse[HourlyMeans17_cavg$hour == 12]
names(ReOrg_RH17_cavg) <- c("y.1", "y.2", "y.3", "y.4", "y.5", "y.6", "y.7", "y.8", "y.9", "y.10", "Dist2Ocean", "LandUse")
...
p17c <- (length(unique(HourlyMeans17_cavg$LandUse))) + 1 #number of predictors, have to account for categorical land use
...
starting17 <-list("beta"=rep(0,N.t*p17c), "phi"=rep(3/(0.5*x.d), N.t),
                 "sigma.sq"=rep(1,N.t), "tau.sq"=rep(1, N.t),
                 "sigma.eta"=diag(rep(0.01, p17c)))

priors17 <- list("beta.0.Norm"=list(rep(0,p17), diag(1000,p17c)),
               "phi.Unif"=list(rep(3/(0.9*x.d),N.t), rep(3/(0.001*x.d),N.t)),
               "sigma.sq.IG"=list(rep(2,N.t), rep(10,N.t)),
               "tau.sq.IG"=list(rep(2,N.t), rep(10,N.t)),
...
write.csv(signif(coeff, 3), "../../05AnalysisOutputs/SpDynLM_Coefficients_Temp2016_042425.csv")
saveRDS(m.temp.16, "../../05AnalysisOutputs/SpDynLM_Temp2016_042425.rds")
...
write.csv(signif(coeff, 3), "../../05AnalysisOutputs/SpDynLM_Coefficients_RelHum2016_042425.csv")
saveRDS(m.rh.16, "../../05AnalysisOutputs/SpDynLM_RelHum2016_042425.rds")
...
write.csv(signif(coeff, 3), "../../05AnalysisOutputs/SpDynLM_Coefficients_Temp2017_042425.csv")
saveRDS(m.temp.17, "../../05AnalysisOutputs/SpDynLM_Temp2017_042425.rds")
...
write.csv(signif(coeff, 3), "../../05AnalysisOutputs/SpDynLM_Coefficients_RelHum2017_042425.csv")
saveRDS(m.rh.17, "../../05AnalysisOutputs/SpDynLM_RelHum2017_042425.rds")
...
#run the model
m.temp.17c <- spDynLM(mods, data=ReOrg_Temp17_cavg, coords=st_coordinates(coords_UTM),
               starting=starting17, tuning=tuning17, priors=priors17, knots = knots,
               cov.model="exponential", n.samples=n.samples, n.report=500) 


##Relative humidity
m.rh.17c <- spDynLM(mods, data=ReOrg_RH17_cavg, coords=st_coordinates(coords_UTM),
               starting=starting17, tuning=tuning17, priors=priors17, knots = knots,
               cov.model="exponential", n.samples=n.samples, n.report=500) 
```
...
write.csv(signif(coeff, 3), "../../05AnalysisOutputs/SpDynLM_Coefficients_Temp2017_ClimAvg.csv")
saveRDS(m.temp.17c, "../../05AnalysisOutputs/SpDynLM_Temp2017_ClimAvg.rds")
...
write.csv(signif(coeff, 3), "../../05AnalysisOutputs/SpDynLM_Coefficients_RelHum2017_ClimAvg_042425.csv")
saveRDS(m.rh.17c, "../../05AnalysisOutputs/SpDynLM_RelHum2017_ClimAvg_042425.rds")
